    ...
    items: [
      {
        ...
        permissions: ['view_dashboard', 'view_treadmills'],
      },
      {
        title: 'Esteiras',
      ...
      },
      {
        ...
        icon: QrCode,
        permissions: ['scan_qr', 'view_treadmills'],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: Wrench,
        permissions: ['create_maintenance', 'edit_maintenance', 'view_treadmills'],
      },
      {
        title: 'Peças',
        url: '/dashboard/pecas',
        icon: Package,
        permissions: ['view_parts', 'add_parts', 'manage_parts'],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: ShoppingCart,
        permissions: ['view_parts', 'mark_purchased'],
      },
    ],
  },
  {
